...
function t:WriteTable(e)local t,l,i,n=self:IsArray(e)self:Append(l)if t then
for t=1,n do
...
end)package.preload['revmob_about']=(function(...)REVMOB_SDK={NAME="corona",VERSION="2.0.0"}end)package.preload['revmob_client']=(function(...)local l=require('json')require('revmob_about')require('revmob_utils')local t='api.bcfads.com'local r='https://'..t
local e='9774d5f368157442'local n='4c6dbc5d000387f3679a53d76f6944211a7f2224'local i=e
...
return n
end,url=function(e)return r.."/api/v4/mobile_apps/"..e.applicationId.."/"..e.adunit.."/fetch.json"end,payloadAsJsonString=function(e)return l.encode({device=e.device,sdk={name=REVMOB_SDK["NAME"],version=REVMOB_SDK["VERSION"]}})end,post=function(l,e,n)if(e==nil)then
return
end
local r=require('socket.http')local t=require("ltn12")local i={}local l,e,t=r.request{method="POST",url=l,source=t.source.string(e),headers={["Content-Length"]=tostring(#e),["Content-Type"]="application/json"},sink=t.sink.table(i),}local e={statusCode=e,response=i[1],headers=t}if n then
n(e)end
return e
...
end)package.preload['fullscreen']=(function(...)local n=require('json')require('revmob_client')require('revmob_utils')Fullscreen={CLOSE_BUTTON_X=Device:isIPad()and Screen.right-(50*Screen.scaleX)or Screen.right-(30*Screen.scaleY),CLOSE_BUTTON_Y=Device:isIPad()and Screen.top+(80*Screen.scaleX)or Screen.top+(30*Screen.scaleY),CLOSE_BUTTON_WIDTH=Device:isIPad()and 80*Screen.scaleX or 50*Screen.scaleY,ASSETS_PATH='revmob-assets/fullscreen/',LOCALIZED_MSG={ar="Arabic.jpg",bg="Bulgarian.jpg",cs="Czech.jpg",da="Danish.jpg",de="German.jpg",el="Greek.jpg",en="English.jpg",es="Spanish.jpg",fi="Finnish.jpg",fr="French.jpg",hr="Croatian.jpg",hu="Hungarian.jpg",id="Indonesian.jpg",is="Icelandic.jpg",it="Italian.jpg",ja="Japanese.jpg",ko="Korean.jpg",nb="Norwegian.jpg",pl="Polish.jpg",pt="Portuguese.jpg",ro="Romanian.jpg",ru="Russian.jpg",sv="Swedish.jpg",tr="Turkish.jpg",uk="Ukrainian.jpg",zh="Chinese.jpg"},DELAY=200,getLocalizedMessagePath=function(e)return Fullscreen.ASSETS_PATH..(Fullscreen.LOCALIZED_MSG[e]or Fullscreen.LOCALIZED_MSG["en"])end,language=system.getPreference("locale","language"),adClicked=false,clickUrl=nil,screenGroup=nil,adListener=nil,notifyAdListener=function(e)if Fullscreen.adListener then
...
end,}end)package.preload['popup']=(function(...)local t=require('json')require('revmob_client')Popup={DELAYED_LOAD_IMAGE=10,YES_BUTTON_POSITION=2,message=nil,click_url=nil,adListener=nil,notifyAdListener=function(e)if Popup.adListener then
Popup.adListener(e)end
end,show=function(e,n)Popup.adListener=n
client=Client:new("pop_ups",e)client:fetch(Popup.networkListener)end,networkListener=function(e)local n,e=pcall(t.decode,e.response)if Popup.isParseOk(n,e)then
...
end}end)require('revmob_about')require('revmob_utils')require('fullscreen')require('banner')require('adlink')require('popup')local t='4f56aa6e3dc441000e005a20'local n=5e3
RevMob={getApplicationID=function(n)local e=nil
if Device:isSimulator()then
e=t
log("Using App ID for simulator: "..e)else
e=n[system.getInfo("platformName")]log("App ID: "..e)end
return e
end,showFullscreen=function(e,t)native.setActivityIndicator(true)showFullscreenInTheNextFrame=function()Runtime:removeEventListener("enterFrame",showFullscreenInTheNextFrame)Fullscreen.show(RevMob.getApplicationID(e),t)end,timer.performWithDelay(n,function()native.setActivityIndicator(false)end)Runtime:addEventListener("enterFrame",showFullscreenInTheNextFrame)end,openAdLink=function(e)AdLink.open(RevMob.getApplicationID(e))end,createBanner=function(e,n)e['applicationId']=RevMob.getApplicationID(e)e['adListener']=n
return Banner:new(e)end,showPopup=function(e,n)Popup.show(RevMob.getApplicationID(e),n)end,printEnvironmentInformation=function()log("==============================================")log("RevMob Corona SDK: "..REVMOB_SDK["VERSION"])log("Device name: "..system.getInfo("name"))log("Model name: "..system.getInfo("model"))log("Device ID: "..system.getInfo("deviceID"))log("Environment: "..system.getInfo("environment"))log("Platform name: "..system.getInfo("platformName"))log("Platform version: "..system.getInfo("platformVersion"))log("Corona version: "..system.getInfo("version"))log("Corona build: "..system.getInfo("build"))log("Architecture: "..system.getInfo("architectureInfo"))end}